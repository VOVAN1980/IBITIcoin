...
Если захочешь, отдельно можем сделать короткую версию README для инвесторов (без команд, только с описанием и картинками), а это оставить как dev-версию в репе.
